...
bool Application::Init(int w, int h)
{
	...
	// ウィンドウ作成
	//===================================================================
	if (m_window.Create(w, h, "3D GameProgramming", "Window"/*,true*/) == false) {
...
void Application::Execute()
{
	...
	while (1)
	{
		...
		std::string titleBar = "Sneak Thief FPS : " + std::to_string(m_fpsController.m_nowfps);
